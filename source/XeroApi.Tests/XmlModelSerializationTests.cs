...
namespace XeroApi.Tests
{
    ...
    {
        private readonly IXmlModelSerializer _serializer = new XmlModelSerializer();
        ...
        {
            string actualXml = _serializer.Serialize(SampleManualJournal);
        ...
        {
            string actualXml = _serializer.Serialize2(SampleManualJournal);
            Assert.AreEqual(SampleManualJournalXml, actualXml);
        }
        ...
        public void serialize_method_can_omit_string_properties_that_are_null()
        {
            ...
            var xml = _serializer.Serialize(contact);
        ...
        public void serialize_2_method_can_omit_string_properties_that_are_null()
        {
            ...
            var xml = _serializer.Serialize2(contact);
            Assert.IsFalse(xml.Contains("PhoneAreaCode"));
        }
